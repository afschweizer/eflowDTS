...
(function(b) {
    var a = function() {
        ...
        function g(s, v, r, u) {
            ...
            var p = f(r);
            if (r.merge) {
                l += '\n\t\t\t\t<Cell ss:MergeAcross="' + r.merge + '" ss:StyleID="' + p + '"><Data ss:Type="' + q + '">' + s + "</Data></Cell>"
            } else {
                l += '\n\t\t\t\t<Cell ss:StyleID="' + p + '"><Data ss:Type="' + q + '">' + s + "</Data></Cell>"
            }
        }
...
(function(b) {
    var a = function() {
        ...
        this.appendBodyCell = function(j, n, g, m, h, l) {
            var k = this.getFormat(n);
            j = this.formatData(j, k.type, k.formatString, k.localization);
            if (k.type == "string") {
...
(function(d) {
    ...
    var c = function() {
        ...
        this.appendBodyCell = function(u, t) {
            var v = this.prepareData(u, t);
            if (hierarchy) {
                o[s][t.text] = v
            } else {
                r[t.text] = v
...
(function(i) {
    ...
    i.cell = function(v, u, z, r, p, t) {
        this.lnMod = this.lnMod === undefined ? 0 : this.lnMod;
        if (this.printingHeaderRow !== true && this.lnMod !== 0) {
            t = t + this.lnMod
        }
        if ((((t * r) + u + (r * 2)) / f) >= this.internal.pageSize.height && f === 1 && !e) {
            this.cellAddPage();
            if (this.printHeaders && this.tableHeaderRow) {
                this.printHeaderRow(t);
                this.lnMod += 1;
                t += 1
            }
            if (l() === 0) {
                j(Math.round((this.internal.pageSize.height - (r * 2)) / r))
            }
        } else {
            if (e && k().ln !== t && g() === l()) {
                this.cellAddPage();
        ...
        var A = k(),
            q = this.getTextDimensions(p),
            s = 1;
        if (A.x !== undefined && A.ln === t) {
            v = A.x + A.w
        }
        if (A.y !== undefined && A.y === u) {
            u = A.y
        }
        if (A.h !== undefined && A.h === r) {
            r = A.h
        }
        if (A.ln !== undefined && A.ln === t) {
            t = A.ln;
            s = 0
        }
        if (e) {
            ...
            u = (u + (r * Math.abs(l() * f - t - l())))
        }
        this.rect(v, u, z, r);
        this.text(p, v + 3, u + r - 3);
        n(g() + s);
        d(v, u, z, r, t);
        return this
    };
