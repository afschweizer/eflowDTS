...
$scope.Save_Visit_Point = function(VP){
     ...
     if(VP.Latitude === "" || typeof VP.Latitude === 'undefined' || VP.Longitude === "" || typeof VP.Longitude === 'undefined'){
		...
		if(typeof VP._id === 'undefined'){
			...
			VP.Route.ID_Route = $scope.Route.ID_Route_Name;
			var JsonData = {
